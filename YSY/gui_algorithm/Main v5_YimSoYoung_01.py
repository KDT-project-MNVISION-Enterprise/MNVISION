...
# 임소영 ===========================================================
valid_01 = r"F:\video_MNV\검증용 데이터\5번카메라_루프렉사이_진입.mp4"
valid_02 = r"F:\video_MNV\검증용 데이터\no헬멧_위험구역_진입.mp4"
valid_03 = r"F:\video_MNV\검증용 데이터\지게차_작업경우.mp4"
valid_04 = r"F:\video_MNV\검증용 데이터\헬멧_위험구역_진입.mp4"

test_filepath = valid_01
...
ort_session = YOLO(m_file)
ort_session2 = YOLO(m_file)
#==========================================================================
...
class ObjectDetection:
    ...
    def apply_model(self,frame, upper_coordinates=None, lower_coordinates=None):
        ...
        if upper_coordinates is None and lower_coordinates is None:
            ...
            ### yolo5 일 경우                    # 이 부분 부터 수정되었습니다. ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐
            frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
            results = self.model(frame)     # yolo_v5이라고 가정하고 predict 코드 진행 
                                            # 이럴 경우 예측결과는 나오지만 frame에 바운딩박스는 그려지지 X
