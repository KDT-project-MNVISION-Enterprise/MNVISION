...
form_class = uic.loadUiType("gui_PyQt/Video2.ui")[0] # Qt designer에서 작성한 ui 파일 불러오기
ort_session = YOLO('gui_PyQt/best.onnx') # 모델 파일 불러오기
...
class WindowClass(QMainWindow, form_class): # 
    ...
    def start_video(self):
        cap = cv2.VideoCapture("gui_PyQt/person.avi") # 동영상 불러오기 
